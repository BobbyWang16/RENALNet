...
#### The CNN folder contains the code of our deep learning model RENALNet, while the machine_learning folder stores the code used for radiomics analysis through machine learning.
